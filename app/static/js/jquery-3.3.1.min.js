/*! jQuery v3.3.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(e, t) {
            ...
            (u = oe.select = function(e, t, n, i) {
                ...
                return (
                    (p || s(e, d))(
                        i,
                        t, !g,
                        n, !t || (K.test(e) && ge(t.parentNode)) || t
                    ),
                    n
                );
            }),
    ...
    (w.event = {
        ...
        dispatch: function(e) {
            ...
            if (
                ((t.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, t))
            ) {
    ...
    w.each({
        ...
        w.fn.extend({
            ...
            off: function(e, t, n) {
                ...
                return (
                    (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = ke),
                    this.each(function() {
    ...
    function Fe(e, t, n) {
        ...
        return (
            ...
            ("" !== (a = n.getPropertyValue(t) || n[t]) ||
                w.contains(e.ownerDocument, e) ||
                (a = w.style(e, t)), !h.pixelBoxStyles() &&
                We.test(a) &&
                Be.test(t) &&
                ((r = s.width),
                    (i = s.minWidth),
    ...
    w.extend(w.event, {
            trigger: function(t, n, i, o) {
                ...
                if (
                    ...
                    if (!o && !d.noBubble && !y(i)) {
                        for (
                            l = d.delegateType || m, wt.test(l + m) || (s = s.parentNode); s; s = s.parentNode
                        )
                            v.push(s), (u = s);
                        u === (i.ownerDocument || r) &&
            ...
            ajax: function(t, n) {
                ...
                0 == w.active++ &&
                    ...
                    ((d = h.url.slice(o.length)),
                        ...
                        ((o += (kt.test(o) ? "&" : "?") + h.data), delete h.data), !1 === h.cache &&
                        ((o = o.replace(Ht, "$1")),
                            (d = (kt.test(o) ? "&" : "?") + "_=" + Et++ + d)),
                        (h.url = o + d)),
                    h.ifModified &&
        ...
        w.each(["get", "post"], function(e, t) {
            w[t] = function(e, n, r, i) {
                return (
                    ...
                    w.ajax(
                        w.extend({ url: e, type: t, dataType: i, data: n, success: r },
                            w.isPlainObject(e) && e
                        )
                    )
                );
                ...
                if (r)
                    return r.getClientRects().length ?
                        ((t = r.getBoundingClientRect()),
                            (n = r.ownerDocument.defaultView), { top: t.top + n.pageYOffset, left: t.left + n.pageXOffset }) :
                        { top: 0, left: 0 };
            },
            position: function() {
                if (this[0]) {
